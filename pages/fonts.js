            ...
            <article className="entry-wraper mb-50">
              <div className="single-excerpt">
                <p className="font-large">
                  Tolerably much and ouch the in began alas more ouch some then
                  accommodating flimsy wholeheartedly after hello slightly the
                  that cow pouted much a goodness bound rebuilt poetically
                  jaguar groundhog
                </p>
              </div>
              <div className="entry-main-content">
                ...
                <p>
                  ...
                  {`it'll automatically be linked up. But if you want to customise
                  your anchor text, you can do that too! Here's a link to`}{" "}
                  <a href="https://alithemes.com">the Alithemes website.</a>
                </p>
                <hr className="wp-block-separator" />
                <h2>Blockquotes</h2>
                ...
                <blockquote cite="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/blockquote">
                  <p>
                    ...
                    (or <em>HTML Block Quotation Element</em>) indicates that
                    the enclosed text is an extended quotation. Usually, this is
                    rendered visually by indentation (see{" "}
                    <a href="https://developer.mozilla.org/en-US/docs/HTML/Element/blockquote#Notes">
                      Notes
                    </a>{" "}
                    for how to change it). A URL for the source of the quotation
                    may be given using the <strong>cite</strong> attribute,
                    ...
                    <a
                      ...
                      title="The HTML Citation Element <cite> represents a reference to a creative work. It must include the title of a work or a URL reference, which may be in an abbreviated form according to the conventions used for the addition of citation metadata."
                    >
                      <code>&lt;cite&gt;</code>
                    </a>{" "}
                    element.
                ...
                <p>
                  <cite>multiple contributors</cite> – MDN HTML element
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>$100M</td>
                      <td>
                        Pictures are worth a thousand words, right? So Jane x
                        1,000.
                      </td>
                    </tr>
                    <tr>
                ...
                <p>
                  ...
                  <a
                    ...
                    href="https://wordpressfoundation.org/"
                  >
                    link
                  </a>
                  .
                ...
                <p>
                  The abbr <abbr title="For The Win">ftw</abbr> stands for “for
                  the win”.
                </p>
                <p>
                ...
                <p>
                  These tests are a big deal, but this tag is no longer
                  supported in HTML5.
                </p>
                <p>
                ...
                <p>
                  ...
                  <code>
                    ...
                    line-height: 1.2;
                    <br />
                    {`and here's a line of some really, really, really, really
                    long text, just to see how it is handled and to find out how
                    it overflows;`}
                    <br />
                    {"}"}
                  </code>
                ...
                <p>
                  This tag will let you <del>strike out text</del>, but this tag
                  is <em>recommended</em> supported in HTML5 (use the{" "}
                  <code>&lt;s&gt;</code> instead).
                </p>
                <p>
                ...
                <p>
                  This tag is for preserving whitespace as typed, such as in
                  poetry or ASCII art.
                </p>
                <hr className="wp-block-separator" />
                ...
                <pre>
                  ...
                  some really, really, really, really long text, just to see how
                  it is handled and to find out how it overflows;`}
                  {"\n"}
                  {"                                "}
                </pre>
                <p>
                ...
                <p>
                  <strong>Strike Tag</strong> (<em>deprecated in HTML5</em>) and{" "}
                  <strong>S Tag</strong>
                </p>
                <p>
                ...
                <p>
                  This rarely used tag emulates, which is usually styled like
                  the <code>&lt;code&gt;</code> tag.
                </p>
                <p>
                  <strong>Underline Tag</strong>{" "}
                  <em>
                    deprecated in HTML 4, re-introduced in HTML5 with other
                    semantics
                  </em>
                </p>
                <p>
