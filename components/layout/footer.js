      ...
      <div className="container">
          ...
          <div className="col-lg-3 col-md-6">
            ...
            >
              ...
              <div className="tagcloud mt-50">
                <Link href="/category/nature" className="tag-cloud-link">
                  #Nature
                </Link>
                <Link href="/category/personal" className="tag-cloud-link">
                  #Personal
                </Link>
                <Link href="/category/travel" className="tag-cloud-link">
                  #Travel
                </Link>
                <Link href="/category/fun" className="tag-cloud-link">
                  #Fun
                </Link>
                <Link href="/category/happiness" className="tag-cloud-link">
                  #Happiness
                </Link>
                <Link href="/category/vehicle" className="tag-cloud-link">
                  #Vehicle
                </Link>
                <Link href="/category/friends" className="tag-cloud-link">
                  #Friends
                </Link>
                <Link href="/category/office" className="tag-cloud-link">
                  #Office
                </Link>
              </div>
            </div>
        ...
        <div className="footer-copy-right pt-30 mt-20 wow fadeInUp animated">
          ...
          <p className="float-md-right font-small text-muted">
            Developed by{" "}
            <Link href="https://Ajay.live" target="_blank">
              Ajay
            </Link>{" "}
            | Keep read buddy
          </p>
